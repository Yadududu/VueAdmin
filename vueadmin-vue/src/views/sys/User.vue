<template>
	<div>
		...
		<el-form :inline="true">
			...
			<el-form-item>
				<el-button type="primary" @click="dialogVisible = true;dialogTitle='添加'" v-if="hasAuth('sys:user:save')">添加</el-button>
			</el-form-item>
			<el-form-item>
		...
		<el-table
			...
			<el-table-column
				...
				<template slot-scope="scope">
					...
					<template>
						<el-popconfirm title="确定删除这条内容吗？" @confirm="delHandle(scope.row.id)">
